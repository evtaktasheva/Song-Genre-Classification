...
|```topK```|```Random Forest```|
|--------------|-------------------|
|<img src="https://github.com/evtaktasheva/Song-Genre-Classification/blob/main/img/tfidf.png" alt="drawing" width="200"/>|<img src="https://github.com/evtaktasheva/Song-Genre-Classification/blob/main/img/random_forest.png" alt="drawing" width="200"/>|
